...
const productsDOM = qs(".products-center");
//const image= document.getElementsByName('img').products
const bannerBtn= qs(".banner-btn");
...
class UI {
  ...
  getBagButtons() {
    const buttons = [...document.querySelectorAll(".bag-btn")]; //for it to be an array and not a node list
    buttonsDOM = buttons;
